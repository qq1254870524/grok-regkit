# -*- coding: utf-8 -*-
"""18r41 multi-thread matrix cross runner.
...
def main():
    ...
    report = OUT / f"matrix_18r41_{stamp}.jsonl"
    md_path = OUT / f"MATRIX_18r41_{stamp}.md"
    board = OUT / "_CODEX_MATRIX_18r41_BOARD.md"
    summary = []

    print(
        f"18r41 matrix start workers={WORKERS} count={COUNT} preheat={PREHEAT} "
    ...
    sum_path = OUT / f"matrix_18r41_{stamp}_summary.json"
    sum_path.write_text(json.dumps(summary, ensure_ascii=False, indent=2), encoding="utf-8")

    lines = [
        "# Matrix 18r41 multi-thread",
        f"stamp={stamp}",
        f"workers={WORKERS}",
        f"count={COUNT}",
        f"preheat={PREHEAT}",
