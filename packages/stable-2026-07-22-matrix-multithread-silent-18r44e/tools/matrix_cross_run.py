...
- 2026-07-19r21: OUT matrix_18r29_*; auto-retry stop_requested/empty_log once per cell-round;
...
OUT = BASE / "matrix_runs" / datetime.now().strftime("matrix_18r29_%Y%m%d_%H%M%S")
...
def classify(logs: str) -> str:
    ...
    rules = [
        ...
        # 18r29d: burn/pending markers before early_no so burned mailboxes count as pending_sso
        (
            "pending_sso",
            [
                ...
                "pending_sso:browser_sso_timeout",
