# 18r30 live
time: 2026-07-19T14:14:18
matrix_pid_alive: False
status: 14:14:18 run=False ok=0/10 fail=10 pend=0 phase=finished jobs=10/10 sess_ok=39 sess_fail=36 event=[*] pending_sso 恢复结束。成功 0 | 失败 10 | workers=2
